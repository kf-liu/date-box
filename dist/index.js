...
var _process$env = process.env,
  githubToken = _process$env.GH_TOKEN,
  gistId = _process$env.GIST_ID,
  records = _process$env.RECORDS;
try {
  if (!GH_TOKEN) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            newContents = (0, _counters["default"])(records);
            _context.prev = 10;
